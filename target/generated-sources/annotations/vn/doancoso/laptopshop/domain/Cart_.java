...
public abstract class Cart_ {
	...
	/**
	 * @see vn.doancoso.laptopshop.domain.Cart#total_quantity
	 **/
	public static volatile SingularAttribute<Cart, Long> total_quantity;
	
	/**
	 * @see vn.doancoso.laptopshop.domain.Cart#cartDetails
	 **/
	public static volatile ListAttribute<Cart, CartDetail> cartDetails;
	
	/**
	 * @see vn.doancoso.laptopshop.domain.Cart#id
	 **/
	public static volatile SingularAttribute<Cart, Long> id;
	
	/**
	 * @see vn.doancoso.laptopshop.domain.Cart
	 **/
	public static volatile EntityType<Cart> class_;
	
	/**
	 * @see vn.doancoso.laptopshop.domain.Cart#user
	 **/
